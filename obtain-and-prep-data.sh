...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me gdrive:CSU-con-gen-2020/pre-indexed-chinook-genome  pre-indexed-chinook-genome
...
ln -s /home/mdrod/scratch/chinook-play/chinook-genome-idx genome
...
# Here is what I did (making a symbolic link)
ln -s  /home/mdrod/scratch/course_stuff/fastqs-chr32-160-chinook-8-lanes fastqs
